...
MENU = {
    ...
    "11": ("Проверить массовую ставку 15%", "10_BID_PREVIEW_15.bat"),
    "12": ("Тест ставки 15% на одной кампании", "11_BID_TEST_ONE_15.bat"),
    "13": ("Тест ставки 15% на трёх кампаниях", "12_BID_TEST_THREE_15.bat"),
    "14": ("Поставить ставку 15% на все кампании", "13_BID_ALL_15.bat"),
}
...
def print_menu() -> None:
    ...
    print()
    print(" СТАВКИ")
    print(" [11] Проверить массовую ставку 15%")
    print(" [12] Тест 15% на одной кампании")
    print(" [13] Тест 15% на трёх кампаниях")
    print(" [14] Поставить 15% на все кампании")
    print()
    print("  [0] Выход")
    print()
